...
<h1>Sele\u00e7\u00e3o de vari\u00e1veis</h1><p>Resultados por \u00e1rea de estudo, fam\u00edlias de vari\u00e1veis e valida\u00e7\u00e3o espacial.</p>'''))
    ...
    motion_script = soup.new_tag("script", id="lesson-motion-controller")
    motion_script.string = (ASSETS / "lesson-motion.js").read_text(encoding="utf-8")
    soup.head.append(motion_script)
